...
{/* ============================================================ */}
           ...
           <h1>
            ...
            <p>سهاله " السوق..يجيك" هي فلسفة جديدة في عالم التسوق
                 الإلكتروني. التطبيق يحتوى مجموعة من الخدمات الفريدة التي 
                 يقدمها للعميل أو المشتري للوصول إلى المنتج المطلوب بكل سهولة 
                 و أفضل سعر بالإضافة إلي ميزة التفاوض مع التاجر على سعر المنتج
                  و كذلك ميزة طلب أي منتج و إنتظار منافسات التجار لتوفير الطلب بأفضل سعر. التطبيق جعل التسوق الإلكتروني ممتعاً من حيث التواصل مع التاجر مباشرة و تتبع حالة الطلبات.
